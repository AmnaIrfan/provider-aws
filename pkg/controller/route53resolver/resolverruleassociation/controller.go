...
const (
	...
	errKubeUpdateFailed = "cannot update Resolver Rule Association custom resource"

	errDescribe      = "failed to describe Resolver Rule Association with id"
	errMultipleItems = "retrieved multiple Resolver Rule Association for the given  ResolverRuleAssociationId"
	errCreate        = "failed to create the  Resolver Rule Association resource"
	errCreateTags    = "failed to create tags for the Resolver Rule Association resource"
...
func (e *external) Observe(ctx context.Context, mgd resource.Managed) (managed.ExternalObservation, error) { // nolint:gocyclo
	...
	//the resource from aws
	observed := response.ResolverRuleAssociation
	//the resource in crossplane
